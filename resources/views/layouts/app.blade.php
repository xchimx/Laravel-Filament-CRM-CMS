...
<div class="container mx-auto flex flex-wrap py-6">
    ...
    <aside class="w-full md:w-1/3 flex flex-col items-center px-3">
        ...
        <div class="w-full bg-white shadow flex flex-col my-4 p-6">
            ...
            <p class="pb-2">Hey 👋 My name is Tobias Schottstädt and I'm a full-stack web developer.<br><br>
...
<footer class="w-full border-t bg-white pb-12">
    ...
    <div class="w-full container mx-auto flex flex-col items-center">
        ...
        <div class="uppercase pb-6">Frontend based on <a href="https://github.com/davidgrzyb/tailwind-blog-template">Tailwind
                Blog Template</a></div>
        <div class="uppercase pb-6">Powered by <a href="https://www.schottstaedt.net">Tobias Schottstädt <img
